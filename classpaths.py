# Contains all the path variables that need to be configured before running the program on a new computer
# 
...
OUTDIR_SENTENCES = BASEDIR+'/moderation/archive/output/sentences/'
OUTDIR_PARAGRAPHS = BASEDIR+'/moderation/archive/output/paragraphs/'
...
MANUAL_SENTENCES = BASEDIR+'/moderation/manual/sentences/new_format/'
